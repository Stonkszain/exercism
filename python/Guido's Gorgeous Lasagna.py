...
def preparation_time_in_minutes(no_of_layers):
    ...
    This function takes one number representing the number of layers in the lasagna
    """
...
# Remember to add a docstring (you can copy and then alter the one from bake_time_remaining.)
def elapsed_time_in_minutes(no_of_layers, time):
    """
    ...
    """
    return preparation_time_in_minutes(no_of_layers) + (EXPECTED_BAKE_TIME - bake_time_remaining(time))
